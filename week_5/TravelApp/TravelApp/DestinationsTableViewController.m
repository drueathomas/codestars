...
- (void)viewDidLoad {
    ...
    destinationNames = [dict objectForKey:@"Name"];
    destinationImages = [dict objectForKey:@"Image"];
...
(NSIndexPath *)indexPath
{
    ...
    DestinationTableViewCell *cell = (DestinationTableViewCell *)[tableView
                                                        dequeueReusableCellWithIdentifier:cellIdentifier];
    cell.nameLabel.text = [destinationNames objectAtIndex:indexPath.row];
    cell.distanceLabel.text = [distance objectAtIndex:indexPath.row];
    cell.thumbnailImageView.image = [UIImage imageNamed:[destinationImages objectAtIndex:indexPath.row]];
       return cell;
}
...
//{
//
//    NSString* selectedRecipe = [destinationNames objectAtIndex:indexPath.row];
...
//    [destinationNames removeObjectAtIndex:indexPath.row];
//    [destinationImages removeObjectAtIndex:indexPath.row];
//    [distance removeObjectAtIndex:indexPath.row];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if ([segue.identifier isEqualToString:@"showRecipeDetail"]) {
        ...
        destViewController.recipeName = [destinationNames objectAtIndex:indexPath.row];
    }
}
