...
//  
//
//  Created by Drue Thomas on 9/5/15.
//
//
...
- (void)viewDidLoad {
    ...
    //add the array of destinations to display
    destinations = @[@"Japan", @"Soeul", @"New York City", @"Houston", @"Portland", @"Hanoi", @"Nice", @"Stockholm"];
